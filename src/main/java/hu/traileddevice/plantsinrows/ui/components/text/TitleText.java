...
public class TitleText extends CenteredText{
    public TitleText(String displayText, Font font) {
        super(System.lineSeparator().concat(displayText).concat(System.lineSeparator()), font);
    }
}
